...
class BigCommerce {
  ...
  async get(path, params) {
    return await this.request('get', this.addParamsToPath(path, params));
  }

  async post(path, data, params) {
    return await this.request('post', this.addParamsToPath(path, params), data);
  }

  async put(path, data, params) {
    return await this.request('put', this.addParamsToPath(path, params), data);
  }

  async delete(path, params) {
    return await this.request('delete', this.addParamsToPath(path, params));
  }
}
